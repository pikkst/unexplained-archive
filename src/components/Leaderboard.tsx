  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <div className="bg-mystery-800 rounded-xl border border-mystery-700 overflow-hidden shadow-2xl">
        <div className="grid grid-cols-12 bg-mystery-900 p-4 border-b border-mystery-700 text-sm font-bold text-gray-400 uppercase tracking-wider">
        ...
        {investigators.length === 0 ? (
          ...
          <div key={inv.id} className="grid grid-cols-12 p-4 border-b border-mystery-700 items-center hover:bg-mystery-700/30 transition-colors">
