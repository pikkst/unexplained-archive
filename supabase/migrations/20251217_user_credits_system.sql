...
-- Example: How to use credits
/*
-- User redeems promo code "FIRST100" which gives 10 credits
-- Trigger automatically calls: add_user_credits(user_id, 10, 'promo', 'campaign_redemption', ...)

-- User wants to use 5 credits for AI image generation:
SELECT spend_user_credits(
    'user-uuid',
    5,
    'ai_generation',
    'AI image for case submission',
    'case-uuid'
);

-- Admin manually grants 50 credits to user:
...
-- Check user balance:
SELECT get_user_credits('user-uuid');
*/
